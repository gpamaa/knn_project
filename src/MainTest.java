...
/**
 * rappresenta la classe che contiene il main
 */
		...
		do {
			...
			switch (r) {
				case 1: {
					...
					do {
						try {
							System.out.println("inserire il percorso del file contenente un training set valido:");
				...
				case 2: {
					...
					do {
						try {
							System.out.println(
									"inserire il percorso del file contenente una serializzazione dell'oggetto KNN:");
